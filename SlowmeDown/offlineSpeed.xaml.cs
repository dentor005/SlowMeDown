...
{
    public partial class offlineSpeed : PhoneApplicationPage
    {
       Boolean onlinemode=false;
        ...
        //bool isFirstTime = false;   // To Check if the user is checking the speed for the first time.
        //GeoCoordinate previousPoint = null; // For Storing the Previous Location.
        ...
        void  geolocator_PositionChanged(Geolocator sender, PositionChangedEventArgs args)
        {
            ...
            if (onlinemode == true)
            {
                ...
                webclient.DownloadStringAsync(new System.Uri("http://yourwebisteurl?username=" + username + "&userid=" + password + "&latitude=" + lat + "&longitude=" + longi + "&speed=" + send_speed + "&junk=" + DateTime.Now));
